...
(
    ...
    UniqueVulnerabilityIdentifier    NVARCHAR(100) NOT NULL,
    ...
    PrimaryRawRiskIndicator          NVARCHAR(25)  NOT NULL,
    SecondaryRawRiskIndicator        NVARCHAR(25),
    ...
    IsActive                         NVARCHAR(5),
    UNIQUE (UniqueVulnerabilityIdentifier, VulnerabilityVersion, VulnerabilityRelease) ON CONFLICT IGNORE
);